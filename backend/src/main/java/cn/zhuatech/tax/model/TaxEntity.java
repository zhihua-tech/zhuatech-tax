...
@Entity @Table(name="tax_entity") public class TaxEntity extends BaseEntity {
    ...
    protected TaxEntity(){} public TaxEntity(String code,String name,String workshop,int plannedCapacity){this.code=code;this.name=name;this.workshop=workshop;this.plannedCapacity=plannedCapacity;}
